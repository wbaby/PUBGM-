...
@interface WanChenDylib : NSObject

@end

@implementation WanChenDylib
...
CHConstructor // code block that runs immediately upon load
{
	@autoreleasepool
	{
		...
		// this would be posted using: notify_post("com.mufeng.WanChenDylib.eventname");
		CFNotificationCenterRef darwin = CFNotificationCenterGetDarwinNotifyCenter();
		CFNotificationCenterAddObserver(darwin, NULL, ExternallyPostedNotification, CFSTR("com.mufeng.WanChenDylib.eventname"), NULL, CFNotificationSuspensionBehaviorCoalesce);
